 ...
 * Fingerprint: AMK1.8U2LU45K8L5B3VDWVzO4Lt
 */
export type Cert = {
  name: string;
  date: string;
...
export const CERTS: Cert[] = [
  { name: "Learning Chef", date: "Aug 2026", year: "2026", cat: ["automation"], skills: ["Chef"], url: B + "4c1dc2fd49d5224763c386cc1cf0b743ad209ffed911ffab698cac07028b8d9b/" },
  { name: "Learning Puppet", date: "Aug 2026", year: "2026", cat: ["automation"], skills: ["Puppet"], url: B + "061a4486ebf2c876d31f279f33aa80e4240b44af4bd6c4dbcbb8ec8977ccadfb/" },
