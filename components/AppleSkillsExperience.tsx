 ...
 * Fingerprint: AMK1.NmJ0zriXoUAg2rTZ2Evosk
 */
"use client";
            ...
            return (
              <GlowCard key={skill.name} chrome={false}>
                ...
                >
                  ...
                  <span className="text-[11px] font-mono px-2.5 py-1 rounded-full bg-black/5 dark:bg-white/5 text-[#5a5a5f] dark:text-[#a1a1a6]">
                    {skill.tenure}
                  </span>
                </button>
              </GlowCard>
        ...
        <div className="lg:col-span-7">
          <div className="p-8 sm:p-10 rounded-3xl bg-[#f5f5f7] dark:bg-[#09090c]/80 border border-black/10 dark:border-white/10 backdrop-blur-xl relative overflow-hidden shadow-xl transition-all">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-xs font-mono uppercase tracking-wider text-[#5a5a5f] dark:text-[#9b9ba1] mb-2">
