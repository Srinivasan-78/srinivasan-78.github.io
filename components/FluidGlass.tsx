...
// Ported from React Bits (https://reactbits.dev) — JS component, kept
// loosely typed rather than retrofitted with strict types.
//
// Requires GLB models at public/assets/3d/{lens,bar,cube}.glb and demo
// images at public/assets/demo/{cs1,cs2,cs3}.webp. Not bundled with this
// integration — add them or point the paths below elsewhere.
...
function Lens({ modeProps, ...p }) {
  return <ModeWrapper glb="/assets/demo/3d/lens.glb" geometryKey="Cylinder" followPointer modeProps={modeProps} {...p} />;
}
